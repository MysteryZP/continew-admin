 ...
 */
package top.continew.admin.exception;
...
public class ChannelException extends RuntimeException{
	...
	/** 业务自定义异常 **/
	private ChannelException(ChannelResp channelRetMsg) {
		super(channelRetMsg != null ? channelRetMsg.getChannelErrMsg() : null);
		this.channelResp = channelRetMsg;
	}

	/** 未知状态 **/
	public static ChannelException unknown(String channelErrMsg){
		return new ChannelException(ChannelResp.unknown(channelErrMsg));
	}

	/** 系统内异常 **/
	public static ChannelException sysError(String channelErrMsg){
		return new ChannelException(ChannelResp.sysError(channelErrMsg));
	}
