...
import lombok.Data;
import top.continew.admin.common.enums.ApiCodeEnum;
import top.continew.admin.common.util.lang.ContinewKits;
import top.continew.admin.common.util.lang.JsonKits;
...
public class ApiResp {
    ...
    public static ApiResp okWithSign(Object data, String mchKey){
        ...
        String sign = ContinewKits.getSign(jsonObject, mchKey);
        return new ApiResp(ApiCodeEnum.SUCCESS.getCode(), ApiCodeEnum.SUCCESS.getMsg(), data, sign);
    }

    /** 业务处理成功, 返回简单json格式 **/
    public static ApiResp ok4newJson(String key, Object val){
        return ok(JsonKits.newJson(key, val));
    }

    /** 业务处理成功， 封装分页数据， 仅返回必要参数 **/
    public static ApiResp page(IPage iPage){
